...
def get_eatery_info(eatery_dict, flush_eatery=False):
    ...
    # eatery_id, __eatery_id, eatery_name, eatery_photo_link, location = eatery_dict["eatery_id"], eatery_dict["__eatery_id"], eatery_dict["eatery_name"], eatery_dict["eatery_photo_link"], eatery_dict["location"]
